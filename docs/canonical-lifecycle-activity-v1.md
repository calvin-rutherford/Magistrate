...
This contract does not replace canonical chat, make Herdr lifecycle changes, create a complete worker transcript, add a broker, or implement the visual activity drawer. It does not prove notification timeliness, background delivery, app-store readiness, or physical-iPhone acceptance; those remain release/soak gates.
