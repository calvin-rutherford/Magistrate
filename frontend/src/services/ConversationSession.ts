...
// In-memory only, for the lifetime of this JS session: a full page reload
// starts every thread empty. Chat and Voice Mode share the 'captain' target
// so a turn taken in one shows up in the other without either persisting it.
